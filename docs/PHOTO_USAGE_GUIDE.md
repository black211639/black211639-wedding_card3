...
本專案以照片建立婚禮感。婚紗照尚未拍攝前，先用固定照片 slot 建立版面架構；正式照片進來後，優先維持同名檔案替換，避免修改 HTML / JS。

## 正式照片尚未拍攝時的架構

目前先保留 4 個核心照片 slot：

- `cover.jpg`：首頁 Hero、日期區、Thank You 結尾的主視覺 slot。
- `photo1.jpg`：新人介紹、故事第一章、中式意象第三張的 slot。
- `photo2.jpg`：邀請段落、故事第二章、中式意象第一張的 slot。
- `photo3.jpg`：故事第三章、中式意象第二張、倒數區的 slot。

正式婚紗照還沒拍攝前，可以先使用生活照、求婚照或示意照撐版面，但要把它們視為佔位素材，不要把目前照片當成最終視覺方向。
